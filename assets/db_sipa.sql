...
--
-- Table structure for table `tb_registerkk`
--

CREATE TABLE `tb_registerkk` (
...
INSERT INTO `tb_staff` (`id`, `nip`, `nama`, `jabatan`, `foto`, `password`) VALUES
(1, '001', 'Flora', 'Bagian Pelayanan', 'staff-001.jpeg', 'flora'),
(2, '011', 'Eqy', 'Bagian Pelayanan', 'staff-011.jpeg', 'eqy');
...
--
-- Indexes for table `tb_registerkk`
--
ALTER TABLE `tb_registerkk`
...
--
-- AUTO_INCREMENT for table `tb_registerkk`
--
ALTER TABLE `tb_registerkk`
  MODIFY `no_register` int(11) NOT NULL AUTO_INCREMENT;
